...
type InventoryServiceClient interface {
	GetInventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResult, error)
}
...
func (c *inventoryServiceClient) GetInventory(ctx context.Context, in *InventoryRequest, opts ...grpc.CallOption) (*InventoryResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InventoryResult)
...
type InventoryServiceServer interface {
	GetInventory(context.Context, *InventoryRequest) (*InventoryResult, error)
...
func (UnimplementedInventoryServiceServer) GetInventory(context.Context, *InventoryRequest) (*InventoryResult, error) {
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "inventoryRequest.proto",
}
